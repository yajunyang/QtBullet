...
VolumetricMesh * VolumetricMeshLoader::load(const char * filename, VolumetricMesh::fileFormatType fileFormat, int verbose)
{
  ...
  switch (fileFormat)
  {
    case VolumetricMesh::ASCII:
    {
      ...
      //Zhang//if (elementType_ == CubicMesh::elementType())
      //Zhang//  volumetricMesh = new CubicMesh(filename, VolumetricMesh::ASCII, verbose);
    }
  	break;
    ...
    case VolumetricMesh::BINARY:
    {
      ...
      //Zhang//if (elementType_ == CubicMesh::elementType())
      //Zhang//  volumetricMesh = new CubicMesh(filename, VolumetricMesh::BINARY, verbose);
    }
    break;
...
VolumetricMesh * VolumetricMeshLoader::load(void * fin, int memoryLoad)
{
  ...
  //Zhang//if (elementType_ == CubicMesh::elementType())
  //Zhang//  volumetricMesh = new CubicMesh(fin, memoryLoad);
